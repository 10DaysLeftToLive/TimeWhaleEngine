...
public class Gesture : MonoBehaviour {
	...
	public delegate void PinchHandler(float val, Touch touch1, Touch touch2); 
	...
	public static void Pinch(float val, Touch touch1, Touch touch2){
		if(onPinchE!=null) onPinchE(val, touch1, touch2);
	}
