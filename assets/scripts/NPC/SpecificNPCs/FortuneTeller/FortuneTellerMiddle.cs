...
public class FortuneTellerMiddle : NPC {
	...
	private class InitialEmotionState : EmotionState{
		...
		public InitialEmotionState(NPC toControl, string currentDialogue) : base(toControl, currentDialogue){
			...
			//Apple
			giveAppleReaction.AddAction(new NPCTakeItemAction(toControl));
			...
			//Apple Pie
			giveApplePieReaction.AddAction(new NPCTakeItemAction(toControl));
			...
			//Captain Log
			giveCaptainLogReaction.AddAction(new NPCTakeItemAction(toControl));
			...
			//Flute
			giveFluteReaction.AddAction(new NPCTakeItemAction(toControl));
			...
			//Harp
			giveHarpReaction.AddAction(new NPCTakeItemAction(toControl));
			...
			//Lily Seeds
			giveLilySeedsReaction.AddAction(new NPCTakeItemAction(toControl));
			...
			//Note
			giveNoteReaction.AddAction(new NPCTakeItemAction(toControl));
			...
			//Pendant
			givePendantReaction.AddAction(new NPCTakeItemAction(toControl));
			...
			//Rose
			giveRoseReaction.AddAction(new NPCTakeItemAction(toControl));
			...
			//Seashell
			giveSeashellReaction.AddAction(new NPCTakeItemAction(toControl));
			...
			//Shovel
			giveShovelReaction.AddAction(new NPCTakeItemAction(toControl));
			...
			//Sunflower Seeds
			giveSunflowerSeedsReaction.AddAction(new NPCTakeItemAction(toControl));
			...
			//Toolbox
			giveToolboxReaction.AddAction(new NPCTakeItemAction(toControl));
			...
			//Toy Boat
			giveToyBoatReaction.AddAction(new NPCTakeItemAction(toControl));
			...
			//Toy Sword
			giveToySwordReaction.AddAction(new NPCTakeItemAction(toControl));
			...
			//Tulip Seeds
			giveTulipSeedsReaction.AddAction(new NPCTakeItemAction(toControl));
			...
			//Vegetable
			giveVegetableReaction.AddAction(new NPCTakeItemAction(toControl));
