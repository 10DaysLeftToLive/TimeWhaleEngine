...
public class Knight : MonoBehaviour 
{
	...
	public GameObject knightCopy;
	
	// Use this for initialization
	void Start () 
	{
		// switch our knight to a new material
		knight.SwapMaterial(oldMaterial, oldMaterial);
	...
	void Update () {
		...
		if (Time.frameCount % 300 == 0) {
			Instantiate(knightCopy, new Vector3(Random.Range(-100, 100), Random.Range(-100, 100), 0), new Quaternion(0, 0, speed, 1));
		}
		...
		knight.mLocalTransform.Rotate(0, 0, speed * (Mathf.PI/ 180));
		// Attack
